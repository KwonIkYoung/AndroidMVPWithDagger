...
//                .map(new Func1<SearchChannel, Object>() {
//                    @Override
//                    public Object call(SearchChannel searchChannel) {
//                        return searchChannel.getChannel();
//                    }
//                })
                .map(SearchChannel::getChannel)
                .filter(result -> result != null && result.getResult() > 0)
//                .flatMap(new Func1<ImageResult, Observable<?>>() {
//                    @Override
//                    public Observable<?> call(ImageResult imageResult) {
